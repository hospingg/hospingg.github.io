                        ...
                        <table>
                            ...
                            <tbody>
                                <tr v-for="(item, i) in data.items">
                                    ...
                                    <td class=""><a href="#" @click.prevent="parent.formData = item; $refs.ad.active = 1;">{{item.size}}</a></td>
                                    <td class="link"><a href="#" @click.prevent="parent.formData = item; $refs.ad.active = 1;">{{item.link}}</a></td>
                                    <td class="id">
