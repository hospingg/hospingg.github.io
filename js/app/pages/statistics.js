            ...
            <div class="wrapper page">
                <div class="camp-flex">
                    <div class="campaings-header">
                        ...
                        <button class="new-btn" href="#" @click.prevent="parent.formData.copy = data.multi; $refs.copy.active = 1;">
                            <i class="fas fa-images"></i>
                             <span>Multi banners</span>
                        </button>
                </div>
                    ...
                    <table>
                        <thead>
                            <tr>
                                <th class="id"></th>
                                <th class="image"></th>
                                <th class="image td-5">Campaign</th>
                        ...
                        <tbody>
                            <tr v-for="item in data.items">
                                ...
                                <td class="image"><p class="title">  {{item.campaign_title}}</p></td>
                                <td ><p class="title">{{item.link}}</p></td>
                                <td class="id">
                                    {{item.views}}
                                </td>
                                <td class="id">
